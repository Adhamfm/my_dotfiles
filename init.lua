...
vim.keymap.set('n', '<leader>pv', vim.cmd.Ex, { desc = 'Back to Explorer Netrw' })
...
-- For Telescope scrolling:
-- in ./.local/share/nvim/lazy/telescope.nvim/lua/telescope change 
